...
const sampleJson = `{
  ...
  "summary": "PUNCH is showing strong breakout momentum with aggressive smart money accumulation and an 8.7x volume surge versus baseline. High whale dominance on the buy side. Medium rug risk due to young pair age — position sizing recommended.",
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="card-surface rounded p-5">
              ...
              <p className="text-muted-foreground text-sm">DEX pair data — volume, liquidity, price history, pair age, and DEX context for all major Solana trading pairs.</p>
            </div>
            <div className="card-surface rounded p-5">
