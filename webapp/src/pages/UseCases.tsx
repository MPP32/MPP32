...
await executeBuy(newPairAddress, positionSize);`,
  },
  {
    ...
    problem:
      "Autonomous AI trading agents need real-time market intelligence without human intervention. Traditional data APIs require accounts, API keys, and subscription management — none of which fit agentic workflows where the agent is the user.",
    solution: [
      "HTTP 402 native: server requests payment, agent pays from its own wallet, receives data — no human approval loop",
      "MPP Sessions: agent deposits USDC once, queries thousands of times via off-chain vouchers with sub-100ms overhead",
    ...
    costNote:
      "Agent deposits 10 USDC into MPP session. Covers 1,250 intelligence queries. Refills automatically.",
...
async function evaluateToken(address: string) {
  ...
  },
  {
    ...
    costNote: "Monitor 10 tokens every 30 minutes — $0.096/hour. Total daily surveillance: $2.30.",
  },
  {
    id: "developer",
    ...
    costNote:
      "0.008 pathUSD per API call. Bill users directly via MPP sessions or absorb cost — your choice.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-mpp-card border border-mpp-border rounded-2xl p-10 lg:p-16 text-center">
            ...
            <p className="text-muted-foreground text-base leading-relaxed max-w-xl mx-auto mb-8">
              No account required. No subscription. Paste a token address, pay 0.008 pathUSD, receive full on-chain intelligence in under 2 seconds.
            </p>
