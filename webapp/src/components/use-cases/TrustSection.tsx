const pillars = [
  ...
  },
  {
    ...
    description:
      "Every response carries an ISO timestamp. You know exactly when data was pulled. No stale cache disguised as live data. If the timestamp is 30 minutes old, you know to requery.",
  },
];
          ...
          <div className="bg-mpp-surface border border-mpp-amber/20 rounded-xl p-6 flex flex-col justify-between gap-6">
            <div className="space-y-2">
              ...
              <p className="text-foreground text-sm leading-relaxed">
                Run any token through the Playground and compare what you see against DexScreener. The numbers will match because that is where we got them.
              </p>
            </div>
            <a
              href="/playground"
