...
// Just make sure it's publicly reachable over HTTPS.`,
  },
  {
    ...
    description:
      "Fill out the form with your endpoint URL, pricing (in pathUSD — typically 0.001–0.1 per call), and your Tempo-compatible EVM wallet address (0x…). Your listing is live instantly with a hosted proxy URL.",
    code: null,
  },
  {
    number: "04",
    ...
    description:
      "Callers hit your proxy URL (api.mpp32.org/api/proxy/your-slug). Every successful query settles a payment in pathUSD directly to your wallet — no invoicing, no custody, no waiting. Track stats and edit settings anytime from the Manage Dashboard.",
    code: null,
  },
];
