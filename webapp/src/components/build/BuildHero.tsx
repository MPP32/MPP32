  ...
  return (
    <section className="relative border-b border-mpp-border pt-24 pb-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          Monetize Any HTTP Endpoint. Instantly.
        </h1>
        ...
        >
          You built the AI model, the web-search tool, the OCR service, the
          wallet tracker, the liquidation alert. Now charge for it. Per query,
          direct to your wallet, no middleman. Five payment protocols built in
          for any HTTP API, crypto or not.
        </p>
