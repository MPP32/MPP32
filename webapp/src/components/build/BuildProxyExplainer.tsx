const flowNodes = [
  ...
  { label: "Caller pays", sub: "Tempo to your wallet", highlight: false },
    ...
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed max-w-2xl mb-12">
          Provide your endpoint URL once. MPP32 wraps it with an HTTP 402 payment gate. Callers interact with the proxy — your origin stays hidden and only receives verified, paid requests.
        </p>
